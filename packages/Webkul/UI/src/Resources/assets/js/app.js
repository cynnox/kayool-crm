...
Vue.component(
    "flash-wrapper",
    require("./components/flash-wrapper.vue").default
);
...
Vue.component(
    "attachment-wrapper",
    require("./components/attachment/attachment-wrapper").default
);
Vue.component(
    "attachment-item",
    require("./components/attachment/attachment-item").default
);
Vue.component(
    "image-upload",
    require("./components/image/image-upload").default
);
Vue.component(
    "image-wrapper",
    require("./components/image/image-wrapper").default
);
...
Vue.component(
    "table-component",
    require("./components/datagrid/table").default
);
Vue.component(
    "filter-component",
    require("./components/datagrid/filters").default
);
Vue.component(
    "pagination-component",
    require("./components/datagrid/pagination").default
);
Vue.component(
    "thead-component",
    require("./components/datagrid/table-head").default
);
Vue.component(
    "tbody-component",
    require("./components/datagrid/table-body").default
);
Vue.component(
    "sidebar-filter",
    require("./components/datagrid/side-filter").default
);
...
Vue.component(
    "tree-checkbox",
    require("./components/tree-view/tree-checkbox").default
);
Vue.component(
    "tree-radio",
    require("./components/tree-view/tree-radio").default
);
Vue.component(
    "date-range-basic",
    require("./components/date-range-basic").default
);
